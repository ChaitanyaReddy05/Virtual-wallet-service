...
## Capture Outputs (Imp)*:
After the deployment of stack, outputs of the API's namely GetFundsApi,CreateWalletApi,WithdrawFundsApi,AddFundsApi would be shared as outputs , please capture the API endpoints and paste them in path : userwallet/services.json.
